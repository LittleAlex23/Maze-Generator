...
public enum Tile {
    ...
    CYAN(SpriteSheet.getInstance().getSubimage(7, 0), "cyan"),
    ONWHITE(SpriteSheet.getInstance().getSubimage(1, 1), "onWhite"),
    ...
    ONCYAN(SpriteSheet.getInstance().getSubimage(7, 1), "onCyan");
